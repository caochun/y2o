...
class YOLOv8:
    ...
    def __init__(self, onnx_model: str, input_image: str, confidence_thres: float, iou_thres: float):
        ...
        # 直接硬编码类别映射
        self.classes = {0: "nohat", 1: "withhat"}  # 你的模型只包含 "person"/"hat" 类型
    ...
    def main(self) -> np.ndarray:
        ...
        session = ort.InferenceSession(self.onnx_model, providers=["CPUExecutionProvider", "CUDAExecutionProvider"])
...
detection = YOLOv8("best.onnx", "images/000002.jpg", 0.5, 0.5)
